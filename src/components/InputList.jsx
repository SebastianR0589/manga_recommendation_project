...
const excludedMangaList = Array.isArray(props.excludedMangaInputs) ? props.excludedMangaInputs : [];
    ...
    return (
        <section>
            ...
            <ol className="mangainputs-list" aria-live="polite">{recommendationsListItems}</ol>
            <h2>Mangas you want excluded:</h2>
            <ol className="mangainputs-list" aria-live="polite">{excludedListItems}</ol>
