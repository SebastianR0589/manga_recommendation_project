...
export async function getMangasFromMistral(
  mangasArr,
  excludedMangasArr,
  completionBoolean,
  lengthSelect
  ...
  try {
    const response = await hf.chatCompletion({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `I have ${mangasString}. Please give me a list of recommendations what I should read next! Please exclude ${excludedMangasString} and simliar from the recommendations! ${onlyCompletedMangas} ${lengthSelected}`,
        },
      ],
      max_tokens: 1024,
    });
